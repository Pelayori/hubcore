...
public class PlayerMenuGui {
  ...
  public static void openGui(Player player) {
    ...
    if (online) {
      ...
      final var itemStop = new SGButton(new ItemBuilder(XMaterial.TNT.parseItem())
          .name(ChatUtil.translate(
    ...
    if (!online) {
      final var itemStart = new SGButton(new ItemBuilder(XMaterial.EMERALD_BLOCK.parseItem())
          .name(ChatUtil.translate(
  ...
  public static void openDeleteConfirmation(Player player, Server server) {
    ...
    final var yesButton = new SGButton(new ItemBuilder(XMaterial.EMERALD_BLOCK.parseItem())
        .name(ChatUtil.translate(
            instance.getConfig()
    ...
    final var noButton = new SGButton(new ItemBuilder(XMaterial.TNT.parseItem())
        .name(ChatUtil.translate(
            instance.getConfig()
